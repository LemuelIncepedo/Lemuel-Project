                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a hrerf="../pages/flot.php">Flot Charts</a>
                                    </li>
                                    <li>
                                        <a href="../pages/morris.php">Morris.js Charts</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="../pages/panels-wells.php">Panels and Wells</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="../pages/typography.php">Typography</a>
                                    </li>
                                    <li>
                                        <a href="../pages/icons.php"> Icons</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="../pages/login.php">Blank Page</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
